...
// The nav's "GVW" submenu (LCV/HCV/SCV/ICV). Split into its own file —
// rather than one 28-page mega-spec — because running all 28
...
// that degradation.
const PAGE_KEYS = ['lcv', 'hcv', 'scv', 'icv'];

/**
 * Category listing pages — LCV, HCV, SCV, ICV (see
 ...
 * now: only the lead form(s) on each page. Every page in this group has
 * both Check Truck Price and Call Now.
 *
 * Run:
 * - npm run test:categoryListing:gvw
 */
